...
const ProfilePage = ()=>{
    ...
    const handleLogout = ()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].authStore.clear();
        setUser(null);
        router.push("/");
    };
    ...
    const publishTournament = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$pb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].collection("tournaments").update(id, {
                published: true,
                status: "publicado"
            });
...
//# sourceMappingURL=_898ede3f._.js.map